...
public class PlacesAutoCompleteAdapter_BACKUP extends RecyclerView.Adapter<PlacesAutoCompleteAdapter_BACKUP.PredictionHolder> implements Filterable {
    ...
    public PlacesAutoCompleteAdapter_BACKUP(Context context) {
        mContext = context;
